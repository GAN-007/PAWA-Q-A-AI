...
export default function Toast({ message, type = 'info', duration = 3000 }) {
  ...
  useEffect(() => {
    ...
    }, duration - 300); // Start fade-out animation slightly before removing
  ...
  return (
    <div
      ref={toastRef}
      className={`mb-3 p-4 rounded-lg shadow-lg flex items-center transform transition-all duration-300 ease-out opacity-0 translate-y-2 max-w-sm overflow-hidden ${typeStyles[type] || typeStyles.info}`}
    ...
    >
      ...
      <button
        ...
        className="ml-3 text-current hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none"
      >
